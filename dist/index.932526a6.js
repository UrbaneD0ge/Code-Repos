...
})({"fvYDL":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "737e36b2932526a6";
...
},{}],"hjPqK":[function(require,module,exports) {
...
document.getElementById("save").addEventListener("click", function(event) {
    ...
    if (array.length > 10) {
        ...
        $84a264530b3fb4fb$var$base("Table 1").create(firstTen, function(err, records) {
            if (err) {
                console.error(err);
                return;
            }
        ...
        $84a264530b3fb4fb$var$base("Table 1").create(rest, function(err, records) {
            if (err) {
                console.error(err);
                return;
            }
    ...
    } else $84a264530b3fb4fb$var$base("Table 1").create(array, function(err, records) {
        if (err) {
            console.error(err);
            return;
        }
...
document.getElementById("getLast").addEventListener("click", function(event) {
    ...
    $84a264530b3fb4fb$var$base("Table 1").find(recordId, function(err, record) {
        if (err) {
            console.error(err);
            return;
        }
...
},{}]},["fvYDL","hjPqK"], "hjPqK", "parcelRequirec45e")

//# sourceMappingURL=index.932526a6.js.map
