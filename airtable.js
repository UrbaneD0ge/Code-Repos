...
require = (function() {
    ...
    1: [
        function(require1, module, exports) {
            ...
            var AbortController;
            if (typeof window === "undefined") AbortController = require1("abort-controller");
            else if ("signal" in new Request("")) AbortController = window.AbortController;
            else {
                /* eslint-disable @typescript-eslint/no-var-requires */ var polyfill = require1("abortcontroller-polyfill/dist/cjs-ponyfill");
    ...
    3: [
        function(require1, module, exports) {
            ...
            var get_1 = __importDefault(require1("lodash/get"));
            var isPlainObject_1 = __importDefault(require1("lodash/isPlainObject"));
            var keys_1 = __importDefault(require1("lodash/keys"));
            var fetch_1 = __importDefault(require1("./fetch"));
            var abort_controller_1 = __importDefault(require1("./abort-controller"));
            var object_to_query_param_string_1 = __importDefault(require1("./object_to_query_param_string"));
            var airtable_error_1 = __importDefault(require1("./airtable_error"));
            var table_1 = __importDefault(require1("./table"));
            var http_headers_1 = __importDefault(require1("./http_headers"));
            var run_action_1 = __importDefault(require1("./run_action"));
            var package_version_1 = __importDefault(require1("./package_version"));
            var exponential_backoff_with_jitter_1 = __importDefault(require1("./exponential_backoff_with_jitter"));
    ...
    6: [
        function(require1, module, exports) {
            ...
            var internal_config_json_1 = __importDefault(require1("./internal_config.json"));
    ...
    7: [
        function(require1, module, exports) {
            ...
            // istanbul ignore file
            var node_fetch_1 = __importDefault(require1("node-fetch"));
    ...
    11: [
        function(require1, module, exports) {
            ...
            var isArray_1 = __importDefault(require1("lodash/isArray"));
            var isNil_1 = __importDefault(require1("lodash/isNil"));
            var keys_1 = __importDefault(require1("lodash/keys"));
    ...
    13: [
        function(require1, module, exports) {
            ...
            var isFunction_1 = __importDefault(require1("lodash/isFunction"));
            var keys_1 = __importDefault(require1("lodash/keys"));
            var record_1 = __importDefault(require1("./record"));
            var callback_to_promise_1 = __importDefault(require1("./callback_to_promise"));
            var has_1 = __importDefault(require1("./has"));
            var query_params_1 = require1("./query_params");
            /**
    ...
    14: [
        function(require1, module, exports) {
            ...
            var typecheck_1 = __importDefault(require1("./typecheck"));
            var isString_1 = __importDefault(require1("lodash/isString"));
            var isNumber_1 = __importDefault(require1("lodash/isNumber"));
            var isPlainObject_1 = __importDefault(require1("lodash/isPlainObject"));
            var isBoolean_1 = __importDefault(require1("lodash/isBoolean"));
    ...
    17: [
        function(require1, module, exports) {
            ...
            var isPlainObject_1 = __importDefault(require1("lodash/isPlainObject"));
            var deprecate_1 = __importDefault(require1("./deprecate"));
            var query_1 = __importDefault(require1("./query"));
            var record_1 = __importDefault(require1("./record"));
            var callback_to_promise_1 = __importDefault(require1("./callback_to_promise"));
            var Table = /** @class */ function() {
                ...
                Table.prototype._updateRecords = function(isDestructiveUpdate, recordsDataOrRecordId, recordDataOrOptsOrDone, optsOrDone, done) {
                    ...
                    if (Array.isArray(recordsDataOrRecordId)) {
                        ...
                        var record = new record_1.default(this, recordId);
                        if (isDestructiveUpdate) record.putUpdate(recordData, opts, done);
                        else record.patchUpdate(recordData, opts, done);
                    }
                };
        ...
        function(require1, module, exports) {
                ...
                _createClass(Emitter, [
                    ...
                    },
                    {
                        ...
                        value: function removeEventListener(type, callback) {
                            ...
                            for(var i = 0, l = stack.length; i < l; i++)if (stack[i] === callback) {
                                stack.splice(i, 1);
                                return;
                            }
                        }
                    },
                    {
                        ...
                        value: function dispatchEvent(event) {
                            ...
                            for(var i = 0, l = stack.length; i < l; i++)debounce(stack[i]);
            ...
            var AbortSignal = /*#__PURE__*/ function(_Emitter) {
                ...
                function AbortSignal() {
                    ...
                    if (!_this2.listeners) Emitter.call(_assertThisInitialized(_this2));
     ...
     */ function abortableFetchDecorator(patchTargets) {
                ...
                var Request1 = NativeRequest; // Note that the "unfetch" minimal fetch polyfill defines fetch() without
                // defining window.Request, and this polyfill need to work on top of unfetch
                ...
                if (Request1 && !Request1.prototype.hasOwnProperty("signal") || __FORCE_INSTALL_ABORTCONTROLLER_POLYFILL) {
                    Request1 = function Request1(input, init) {
                        var signal;
                        if (init && init.signal) {
                    ...
                    Request1.prototype = NativeRequest.prototype;
                }
                var realFetch = fetch;
                var abortableFetch = function abortableFetch(input, init) {
                    var signal = Request1 && Request1.prototype.isPrototypeOf(input) ? input.signal : init ? init.signal : undefined;
                    if (signal) {
                        var abortError;
                        try {
    ...
    21: [
        function(require1, module, exports) {
            var hashClear = require1("./_hashClear"), hashDelete = require1("./_hashDelete"), hashGet = require1("./_hashGet"), hashHas = require1("./_hashHas"), hashSet = require1("./_hashSet");
            /**
    ...
    22: [
        function(require1, module, exports) {
            var listCacheClear = require1("./_listCacheClear"), listCacheDelete = require1("./_listCacheDelete"), listCacheGet = require1("./_listCacheGet"), listCacheHas = require1("./_listCacheHas"), listCacheSet = require1("./_listCacheSet");
            /**
    ...
    23: [
        function(require1, module, exports) {
            var getNative = require1("./_getNative"), root = require1("./_root");
    ...
    24: [
        function(require1, module, exports) {
            var mapCacheClear = require1("./_mapCacheClear"), mapCacheDelete = require1("./_mapCacheDelete"), mapCacheGet = require1("./_mapCacheGet"), mapCacheHas = require1("./_mapCacheHas"), mapCacheSet = require1("./_mapCacheSet");
            /**
    ...
    26: [
        function(require1, module, exports) {
            var baseTimes = require1("./_baseTimes"), isArguments = require1("./isArguments"), isArray = require1("./isArray"), isBuffer = require1("./isBuffer"), isIndex = require1("./_isIndex"), isTypedArray = require1("./isTypedArray");
    ...
    29: [
        function(require1, module, exports) {
            var castPath = require1("./_castPath"), toKey = require1("./_toKey");
            /**
    ...
    30: [
        function(require1, module, exports) {
            var Symbol1 = require1("./_Symbol"), getRawTag = require1("./_getRawTag"), objectToString = require1("./_objectToString");
    ...
    31: [
        function(require1, module, exports) {
            var baseGetTag = require1("./_baseGetTag"), isObjectLike = require1("./isObjectLike");
    ...
    32: [
        function(require1, module, exports) {
            var isFunction = require1("./isFunction"), isMasked = require1("./_isMasked"), isObject = require1("./isObject"), toSource = require1("./_toSource");
            /**
    ...
    33: [
        function(require1, module, exports) {
            var baseGetTag = require1("./_baseGetTag"), isLength = require1("./isLength"), isObjectLike = require1("./isObjectLike");
    ...
    34: [
        function(require1, module, exports) {
            var isPrototype = require1("./_isPrototype"), nativeKeys = require1("./_nativeKeys");
            /** Used for built-in method references. */ var objectProto = Object.prototype;
            /** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
            /**
    ...
    36: [
        function(require1, module, exports) {
            var Symbol1 = require1("./_Symbol"), arrayMap = require1("./_arrayMap"), isArray = require1("./isArray"), isSymbol = require1("./isSymbol");
    ...
    38: [
        function(require1, module, exports) {
            var isArray = require1("./isArray"), isKey = require1("./_isKey"), stringToPath = require1("./_stringToPath"), toString = require1("./toString");
            /**
    ...
    40: [
        function(require1, module, exports) {
            (function(global1) {
                /** Detect free variable `global` from Node.js. */ var freeGlobal = typeof global1 == "object" && global1 && global1.Object === Object && global1;
    ...
    41: [
        function(require1, module, exports) {
            var isKeyable = require1("./_isKeyable");
            /**
    ...
    42: [
        function(require1, module, exports) {
            var baseIsNative = require1("./_baseIsNative"), getValue = require1("./_getValue");
            /**
    ...
    46: [
        function(require1, module, exports) {
            var nativeCreate = require1("./_nativeCreate");
            /**
    ...
    52: [
        function(require1, module, exports) {
            var isArray = require1("./isArray"), isSymbol = require1("./isSymbol");
    ...
    54: [
        function(require1, module, exports) {
            var coreJsData = require1("./_coreJsData");
    ...
    57: [
        function(require1, module, exports) {
            var assocIndexOf = require1("./_assocIndexOf");
    ...
    61: [
        function(require1, module, exports) {
            var Hash = require1("./_Hash"), ListCache = require1("./_ListCache"), Map = require1("./_Map");
            /**
    ...
    62: [
        function(require1, module, exports) {
            var getMapData = require1("./_getMapData");
            /**
    ...
    67: [
        function(require1, module, exports) {
            var getNative = require1("./_getNative");
    ...
    69: [
        function(require1, module, exports) {
            var freeGlobal = require1("./_freeGlobal");
    ...
    73: [
        function(require1, module, exports) {
            var memoizeCapped = require1("./_memoizeCapped");
    ...
    74: [
        function(require1, module, exports) {
            var isSymbol = require1("./isSymbol");
            /** Used as references for various `Number` constants. */ var INFINITY = 1 / 0;
            /**
    ...
    78: [
        function(require1, module, exports) {
            var baseIsArguments = require1("./_baseIsArguments"), isObjectLike = require1("./isObjectLike");
            /** Used for built-in method references. */ var objectProto = Object.prototype;
            /** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
    ...
    80: [
        function(require1, module, exports) {
            var isFunction = require1("./isFunction"), isLength = require1("./isLength");
            /**
    ...
    82: [
        function(require1, module, exports) {
            var root = require1("./_root"), stubFalse = require1("./stubFalse");
            /** Detect free variable `exports`. */ var freeExports = typeof exports == "object" && exports && !exports.nodeType && exports;
            /** Detect free variable `module`. */ var freeModule = freeExports && typeof module == "object" && module && !module.nodeType && module;
            /** Detect the popular CommonJS extension `module.exports`. */ var moduleExports = freeModule && freeModule.exports === freeExports;
    ...
    83: [
        function(require1, module, exports) {
            var baseGetTag = require1("./_baseGetTag"), isObject = require1("./isObject");
    ...
    89: [
        function(require1, module, exports) {
            var baseGetTag = require1("./_baseGetTag"), getPrototype = require1("./_getPrototype"), isObjectLike = require1("./isObjectLike");
    ...
    90: [
        function(require1, module, exports) {
            var baseGetTag = require1("./_baseGetTag"), isArray = require1("./isArray"), isObjectLike = require1("./isObjectLike");
    ...
    92: [
        function(require1, module, exports) {
            var baseIsTypedArray = require1("./_baseIsTypedArray"), baseUnary = require1("./_baseUnary"), nodeUtil = require1("./_nodeUtil");
    ...
    93: [
        function(require1, module, exports) {
            var arrayLikeKeys = require1("./_arrayLikeKeys"), baseKeys = require1("./_baseKeys"), isArrayLike = require1("./isArrayLike");
            /**
    ...
    94: [
        function(require1, module, exports) {
            var MapCache = require1("./_MapCache");
    ...
    96: [
        function(require1, module, exports) {
            var baseToString = require1("./_baseToString");
            /**
    ...
    "airtable": [
        function(require1, module, exports) {
            ...
            var base_1 = __importDefault(require1("./base"));
            var record_1 = __importDefault(require1("./record"));
            var table_1 = __importDefault(require1("./table"));
            var airtable_error_1 = __importDefault(require1("./airtable_error"));
...
function $84a264530b3fb4fb$var$storeForm() {
    // header inputs
...
window.onload = function() {
    ...
    $84a264530b3fb4fb$var$field.value = new Date(Date.now()).toISOString().substring(0, 10);
...
document.querySelector("#itmType").addEventListener("change", $84a264530b3fb4fb$var$preFill);
function $84a264530b3fb4fb$var$preFill() {
    switch(document.querySelector("#itmType").value){
        case "MOSE":
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "Applicant Name");
            $84a264530b3fb4fb$var$applName.value = "";
            break;
        case "LRB":
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "Applicant Name");
            $84a264530b3fb4fb$var$applName.value = "";
            break;
        case "ZRB":
            $84a264530b3fb4fb$var$applName.value = "Z-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "Z-");
            break;
        case "SUP":
            $84a264530b3fb4fb$var$applName.value = "U-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "U-");
            break;
        case "BZA":
            $84a264530b3fb4fb$var$applName.value = "V-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "V-");
            break;
        case "Text Amendment":
            $84a264530b3fb4fb$var$applName.value = "Z-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "Z-");
            break;
        case "CDP":
            $84a264530b3fb4fb$var$applName.value = "CDP-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "CDP-");
            break;
        case "SD":
            $84a264530b3fb4fb$var$applName.value = "SD-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "SD-");
            break;
        case "LOR":
            $84a264530b3fb4fb$var$applName.value = "LOR-22-";
            $84a264530b3fb4fb$var$applName.setAttribute("placeholder", "LOR-");
            break;
        case "N/A":
            $84a264530b3fb4fb$var$applName.value = "";
            $84a264530b3fb4fb$var$applName.removeAttribute("placeholder");
            break;
    }
}
// on submit, add form data to table
$84a264530b3fb4fb$var$submit.addEventListener("click", (e)=>{
    e.preventDefault();
    // // Add Item form
    ...
    if (itmType === "Type" || applName === "") return;
    // create table row
    ...
    $84a264530b3fb4fb$var$table.append(tbody);
    // append cells to row
    ...
    $84a264530b3fb4fb$var$removeDemo();
});
...
document.querySelector("#table").addEventListener("click", (e)=>{
    if (e.target.classList.contains("btn-close")) {
        ...
        if ($84a264530b3fb4fb$var$table.rows.length === 1) $84a264530b3fb4fb$var$addDemo();
    }
});
...
function $84a264530b3fb4fb$var$addDemo() {
    let row = document.createElement("tr");
    let itmTypeCell = document.createElement("td");
    let applNameCell = document.createElement("td");
    let disposalCell = document.createElement("td");
...
function $84a264530b3fb4fb$var$removeDemo() {
...
document.querySelector("#table").addEventListener("click", (e)=>{
    ...
    e.target.addEventListener("blur", (e)=>{
        if (e.target.tagName === "SELECT") e.target.parentElement.textContent = e.target.value;
    });
});
...
let $84a264530b3fb4fb$var$field = document.querySelector("#date");
// listen for print event
window.addEventListener("beforeprint", ()=>{
    let NPU = document.getElementById("NPU").value;
    // Get the date
    let date = new Date(`${$84a264530b3fb4fb$var$field.value}T00:00:00`);
    ...
    document.querySelectorAll('td[contenteditable="true"]').forEach((cell)=>{
        if (cell.textContent === "") cell.parentElement.remove();
    });
...
window.addEventListener("afterprint", ()=>{
    ...
    $84a264530b3fb4fb$var$storeForm();
...
document.getElementById("save").addEventListener("click", function(event) {
    ...
    for(let i = 1; i < rows.length; i++){
        ...
        for(let j = 0; j < cells.length; j++){
            ...
            if (cellName === "disp") cont[cellName] = [
                cellValue
            ];
            else cont[cellName] = cellValue;
        ...
        if (Object.keys(cont).length > 1) cont["fldSdIFMSRkdJGd9Z"] = "NPU-" + NPU + "_" + new Date().toLocaleDateString();
    ...
    if (array.length > 10) {
        ...
        base("Table 1").create(firstTen, function(err, records) {
            ...
            records.forEach(function(record) {
                ...
                if (recordIds) recordIds += "," + recordId;
                else recordIds = recordId;
